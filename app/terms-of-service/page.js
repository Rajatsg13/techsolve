  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="space-y-8 text-slate-700 leading-relaxed text-sm">
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-800 mb-3">4. Permitted Use</h2>
          <p>You agree to use the service only for lawful purposes. You must not:</p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>Process files or data that you do not own or have no legal right to use</li>
            <li>Attempt to reverse-engineer, scrape, or otherwise damage the website</li>
            <li>Use automated tools to access the service in a way that disrupts normal usage for others</li>
            <li>Use the service for any purpose that violates applicable Indian or international law</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>Reliance on any tool output, calculation result, or content on this website</li>
            <li>Any error, interruption, or failure of the tools</li>
            <li>Any action taken or not taken based on information provided on this site</li>
          </ul>
          <p className="mt-3">
        ...
        <section>
          <h2 className="text-lg font-bold text-slate-800 mb-3">14. Contact</h2>
          <p>
